...
export class RecipeService {
  ...
  private recipes: Recipe[] = [
    new Recipe(
      ...
      "Frozen Chocolate-Covered Bananas", `PREP TIME - 20 mins COOK TIME - 2 mins CHILL TIME - 2 h - TOTAL TIME - 2 hrs 22 mins 
...
new Ingredient("sprinkles - nuts, or shredded coconut for topping", "as per taste")
]
